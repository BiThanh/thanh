...
namespace pnthanh_k22cntt_2210900066_prj2.Controllers
{
    public class DonHangsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,idKhachHang,ngayDat,tongTien,trangThai")] DonHang donHang)
        {
            ...
            ViewBag.idKhachHang = new SelectList(db.KhachHang, "id", "tenKhachHang", donHang.idKhachHang);
            return View(donHang);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,idKhachHang,ngayDat,tongTien,trangThai")] DonHang donHang)
        {
            if (ModelState.IsValid)
            {
