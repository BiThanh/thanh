...
namespace pnthanh_k22cntt_2210900066_prj2.Controllers
{
    public class SanPhamsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,tenSanPham,gia,soLuong,moTa,idDanhMuc")] SanPham sanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,tenSanPham,gia,soLuong,moTa,idDanhMuc")] SanPham sanPham)
        {
            if (ModelState.IsValid)
            {
